...
// Wed Nov 27 16:20:51 2019 by ROOT version 6.18/04
// from TTree rec/rec
// found on file: D1.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("4GSS5000.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("4GSS5000.root");
      }
